...
const HomeSection = () => {
    return (
        <section id="home" className="max-w-[1320px] mx-auto flex flex-col justify-center items-center gap-4 h-[95vh] px-6">
            ...
            <div className="flex flex-col items-center max-w-[900px] gap-3">
                <h1 className="text-[60px] text-center leading-[65px] font-bold text-2xl md:text-6xl "><span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-red-500 to-yellow-500">Olá, meu nome é Gabriel,</span> sou desenvolvedor front-end.</h1>
